...
public class Solution {
    ...
    public synchronized String getPartOfString(String string, String threadName) {
        if (threadName.equals("1#")) throw new TooShortStringFirstThreadException(new StringIndexOutOfBoundsException("String index out of range: -1"));
        else if (threadName.equals("2#")) throw new TooShortStringSecondThreadException(new StringIndexOutOfBoundsException("String index out of range: -1"));
        if (string == null ||
                string.indexOf("\t") == -1 || string.indexOf("\t") == string.lastIndexOf("\t"))
