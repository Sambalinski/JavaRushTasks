...
public class AmigoOutputStream extends FileOutputStream {
    ...
    private FileOutputStream exemplar;

    public AmigoOutputStream(FileOutputStream exemplar) throws FileNotFoundException {
        super(fileName);
    ...
    public void close() throws IOException {
        exemplar.flush();
        exemplar.write("JavaRush © All rights reserved.".getBytes());
        exemplar.close();
    }
