...
public class Solution {
    ...
    public static void main(String[] args) {
        ...
        String sArr [] = s.split(" ");
        if (sArr[1].equals("*")) System.out.println(s + (Integer.parseInt(sArr[0]) * Integer.parseInt(sArr[2])));
        else if (sArr[1].equals("-")) System.out.println(s + (Integer.parseInt(sArr[0]) - Integer.parseInt(sArr[2])));
        else if (sArr[1].equals("+")) System.out.println(s + (Integer.parseInt(sArr[0]) + Integer.parseInt(sArr[2])));
    }
