...
1. Разобраться, что делает программа.
2. Почитать про UncaughtExceptionHandler - это важно.
3. Еще раз внимательно посмотреть программу.
4. Разобраться - продебажить - почему наш OurUncaughtExceptionHandler не срабатывает.
5. Исправить ошибку, т.е. все должно работать. :)
6. Ожидаемый результат в произвольном порядке:
7. Нить 1: My exception message
8. Нить 2: My exception message
